...
public class BingoModel {
    ...
    static {
        ...
        DATA.put("Besprechungen", Arrays.asList(
                "Synergie", "Sich schlau machen", "treiben", "reporten",
                "SSC", "Kommunizieren", "FMB", "CIP",
                "Problematik", "IT", "Kostenreduzierung", "Fokussieren",
                "Zielführend", "Mindset", "Hut aufhaben", "Abbau"));
    }
